...
int ColorDetection::visionTask() {
    ...
    while(true)
    {
        ...
        if(GV < BLUE_HUE_HIGH && GV > BLUE_HEU_LOW && Bot::DistanceC.objectDistance(vex::mm) < 200) {
            //Blue Ring
        ...
        } else if( GV < RED_HUE_HIGH && GV > RED_HUE_LOW && Bot::DistanceC.objectDistance(vex::mm) < 200) {
            //Red Ring
